...
export default function PnlDashboard() {
    const {
        ...
        adjustments,
        expenses,
        wastage,     // ✅ FIX — correct name from hook
        events,
        daily,
        monthly,
        yearly,
    ...
    const currentSeries = useMemo(() => {
        ...
        const op = events
            .filter((e) =>
                ["PURCHASE_TRAVEL", "DAMAGE_LOSS", "GENERAL_EXPENSE", "WASTAGE"].includes(e.type)
            )
    ...
    const colors = ["#F97316", "#EF4444", "#06B6D4", "#10B981", "#9333EA"];
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-bold">P&L Dashboard (with Wastage)</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                {/* PIE CHART */}
                <div className="p-4 bg-white rounded shadow">
                    <h3 className="font-semibold mb-3">Expense Breakdown (incl. Wastage)</h3>
